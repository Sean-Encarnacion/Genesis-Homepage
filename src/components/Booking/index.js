...
import { Container, FormWrap, Icon, FormContent, Form, FormH1, FormLabel, FormSelect, FormInput, FormInputBtn, FormButton, Text } from './BookingElements'
...
const Booking = () => {
    ...
    emailjs.sendForm('gmail', 'template_c0857a4', e.target, '5skgWqC7tKNlBOnk2')
      .then((result) => {
        ...
        <FormWrap>
            ...
            <FormContent>
                <Form action='' method='POST' onSubmit={sendEmail}>
                    ...
                    <FormLabel htmlFor='for'>Number of Visitor
                    ...
                    <FormInputBtn  name='submit' type='submit'>Book</FormInputBtn>
                </Form>
            </FormContent>
        </FormWrap>
    </Container>
